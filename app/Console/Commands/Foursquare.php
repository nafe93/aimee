...
class Foursquare extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'foursquare';
    ...
    public function handle()
    {
        ...
        foreach (User::get() as $user) {
            ...
            if ($providers->contains('name', 'foursquare')) {
                // Get latest content
                $content = json_decode(Spark::interact(FoursquareRepository::class.'@', [
                    $user->getAccessToken('foursquare')
                ]));
