...
class LastFm extends Command
{
    ...
    public function handle()
    {
        ...
        foreach (User::get() as $user) {
            ...
            if ($providers->contains('name', 'lastfm')) {
                // Get latest content
                $content = json_decode(Spark::interact(LastFmRepository::class.'@', [
                    $user->getAccessToken('lastfm')
                ]));
