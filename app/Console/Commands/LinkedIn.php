...
class LinkedIn extends Command
{
    /**
    ...
    public function handle()
    {
        ...
        foreach (User::get() as $user) {
            ...
            if ($providers->contains('name', 'linkedin')) {
                // Get latest content
                $content = json_decode(Spark::interact(LinkedInRepository::class.'@getData', [
                    $user->getAccessToken('linkedin')
                ]));
