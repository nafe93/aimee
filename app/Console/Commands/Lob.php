...
class Lob extends Command
{
    ...
    public function handle()
    {
        ...
        foreach (User::get() as $user) {
            ...
            if ($providers->contains('name', 'lob')) {
                // Get latest content
                $content = json_decode(Spark::interact(LobRepository::class.'@', [
                    $user->getAccessToken('lob')
                ]));
