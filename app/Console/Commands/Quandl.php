...
class Quandl extends Command
{
    ...
    public function handle()
    {
        ...
        foreach (User::get() as $user) {
            ...
            // TODO Execute conditionally
            if (true) {
                // Get latest content
                $content = json_decode(Spark::interact(QuandlRepository::class.'@', [
                    $user->getAccessToken('quandl')
                ]));
