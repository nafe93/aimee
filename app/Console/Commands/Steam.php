...
use App\Contracts\Repositories\SteamRepository;
use App\User;
...
class Steam extends Command
{
    ...
    public function handle()
    {
        ...
        foreach (User::get() as $user) {
            ...
            if ($providers->contains('name', 'steam')) {
                // Get latest content
                $content = json_decode(Spark::interact(SteamRepository::class.'@', [
                    $user->getAccessToken('steam')
                ]));
