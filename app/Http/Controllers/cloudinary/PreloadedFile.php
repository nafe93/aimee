...
data-atlassian-id="557058:9703eccd-6e07-453d-aae3-cd10aea6d71e" />
  ...
  / source  / app / Http / Controllers / cloudinary / PreloadedFile.php
 &mdash; Bitbucket
</title>
...
<meta name="apitoken" content="{&quot;token&quot;: &quot;agi385OKyhDsW7tqCV-MUsuk8hfzOy5pEJFvE21-yDRIj6R3U7IRse65aSBIcyOCRb09lqyVilc4tFXJcafOIdO6eJ4p&quot;, &quot;connectionId&quot;: 619065, &quot;expiration&quot;: 1493813350.098029}">
...
<header id="source-path">
    ...
    <div class="secondary-actions">
      <div class="aui-buttons">
          ...
          <a href="/crazyhare86/aimee_debug/src/0b821ab99a1b/app/Http/Controllers/cloudinary/PreloadedFile.php?at=Nafanail"
            class="aui-button pjax-trigger" aria-pressed="true">
            Source
          </a>
          <a href="/crazyhare86/aimee_debug/diff/app/Http/Controllers/cloudinary/PreloadedFile.php?diff2=0b821ab99a1b&at=Nafanail"
            class="aui-button pjax-trigger"
            title="Diff to previous change">
            Diff
          </a>
          <a href="/crazyhare86/aimee_debug/history-node/0b821ab99a1b/app/Http/Controllers/cloudinary/PreloadedFile.php?at=Nafanail"
            class="aui-button pjax-trigger">
            History
          </a>
  ...
  <h1>
        ...
        <a href="/crazyhare86/aimee_debug/src/0b821ab99a1b?at=Nafanail"
          class="pjax-trigger root" title="crazyhare86/aimee_debug at 0b821ab99a1b">aimee_debug</a> /
            ...
            <span class="file-name">PreloadedFile.php</span>
  ...
  <div id="editor-container" class="maskable"
       ...
       data-path="app/Http/Controllers/cloudinary/PreloadedFile.php"
       data-source-url="/api/internal/repositories/crazyhare86/aimee_debug/src/0b821ab99a1ba2bbea61af849a1c88d39986036a/app/Http/Controllers/cloudinary/PreloadedFile.php">
  ...
  <span class="aui-icon-dropdown"></span>
          ...
          <a href="/crazyhare86/aimee_debug/full-commit/0b821ab99a1b/app/Http/Controllers/cloudinary/PreloadedFile.php" id="full-commit-link"
        ...
        <div class="secondary">
          ...
          <div class="aui-buttons">
              ...
              <a href="/crazyhare86/aimee_debug/annotate/0b821ab99a1ba2bbea61af849a1c88d39986036a/app/Http/Controllers/cloudinary/PreloadedFile.php?at=Nafanail"
                 class="aui-button aui-button-light pjax-trigger">Blame</a>
              
            
            <a href="/crazyhare86/aimee_debug/raw/0b821ab99a1ba2bbea61af849a1c88d39986036a/app/Http/Controllers/cloudinary/PreloadedFile.php" class="aui-button aui-button-light">Raw</a>
          </div>
    ...
    <div class="file-source">
      <table class="codehilite highlighttable"><tr><td class="linenos"><div class="linenodiv"><pre><a href="#PreloadedFile.php-1"> 1</a>
<a href="#PreloadedFile.php-2"> 2</a>
<a href="#PreloadedFile.php-3"> 3</a>
<a href="#PreloadedFile.php-4"> 4</a>
<a href="#PreloadedFile.php-5"> 5</a>
<a href="#PreloadedFile.php-6"> 6</a>
<a href="#PreloadedFile.php-7"> 7</a>
<a href="#PreloadedFile.php-8"> 8</a>
<a href="#PreloadedFile.php-9"> 9</a>
<a href="#PreloadedFile.php-10">10</a>
<a href="#PreloadedFile.php-11">11</a>
<a href="#PreloadedFile.php-12">12</a>
<a href="#PreloadedFile.php-13">13</a>
<a href="#PreloadedFile.php-14">14</a>
<a href="#PreloadedFile.php-15">15</a>
<a href="#PreloadedFile.php-16">16</a>
<a href="#PreloadedFile.php-17">17</a>
<a href="#PreloadedFile.php-18">18</a>
<a href="#PreloadedFile.php-19">19</a>
<a href="#PreloadedFile.php-20">20</a>
<a href="#PreloadedFile.php-21">21</a>
<a href="#PreloadedFile.php-22">22</a>
<a href="#PreloadedFile.php-23">23</a>
<a href="#PreloadedFile.php-24">24</a>
<a href="#PreloadedFile.php-25">25</a>
<a href="#PreloadedFile.php-26">26</a>
<a href="#PreloadedFile.php-27">27</a>
<a href="#PreloadedFile.php-28">28</a>
<a href="#PreloadedFile.php-29">29</a>
<a href="#PreloadedFile.php-30">30</a>
<a href="#PreloadedFile.php-31">31</a>
<a href="#PreloadedFile.php-32">32</a>
<a href="#PreloadedFile.php-33">33</a>
<a href="#PreloadedFile.php-34">34</a>
<a href="#PreloadedFile.php-35">35</a>
<a href="#PreloadedFile.php-36">36</a>
<a href="#PreloadedFile.php-37">37</a>
<a href="#PreloadedFile.php-38">38</a>
<a href="#PreloadedFile.php-39">39</a>
<a href="#PreloadedFile.php-40">40</a>
<a href="#PreloadedFile.php-41">41</a>
<a href="#PreloadedFile.php-42">42</a>
<a href="#PreloadedFile.php-43">43</a>
<a href="#PreloadedFile.php-44">44</a>
<a href="#PreloadedFile.php-45">45</a>
<a href="#PreloadedFile.php-46">46</a>
<a href="#PreloadedFile.php-47">47</a>
<a href="#PreloadedFile.php-48">48</a>
<a href="#PreloadedFile.php-49">49</a>
<a href="#PreloadedFile.php-50">50</a>
<a href="#PreloadedFile.php-51">51</a>
<a href="#PreloadedFile.php-52">52</a></pre></div></td><td class="code"><div class="codehilite highlight"><pre><span></span><a name="PreloadedFile.php-1"></a><span class="cp">&lt;?php</span>
<a name="PreloadedFile.php-2"></a><span class="k">namespace</span> <span class="nx">Cloudinary</span> <span class="p">{</span>
<a name="PreloadedFile.php-3"></a>    <span class="k">class</span> <span class="nc">PreloadedFile</span> <span class="p">{</span>
<a name="PreloadedFile.php-4"></a>        <span class="k">public</span> <span class="k">static</span> <span class="nv">$PRELOADED_CLOUDINARY_PATH</span> <span class="o">=</span> <span class="s2">&quot;/^([^\/]+)\/([^\/]+)\/v(\d+)\/([^#]+)#([^\/]+)$/&quot;</span><span class="p">;</span>
<a name="PreloadedFile.php-5"></a>        
<a name="PreloadedFile.php-6"></a>        <span class="k">public</span> <span class="nv">$filename</span><span class="p">,</span> <span class="nv">$version</span><span class="p">,</span> <span class="nv">$public_id</span><span class="p">,</span> <span class="nv">$signature</span><span class="p">,</span> <span class="nv">$resource_type</span><span class="p">,</span> <span class="nv">$type</span><span class="p">;</span>
<a name="PreloadedFile.php-7"></a>        
<a name="PreloadedFile.php-8"></a>        <span class="k">public</span> <span class="k">function</span> <span class="fm">__construct</span><span class="p">(</span><span class="nv">$file_info</span><span class="p">)</span> <span class="p">{</span>
<a name="PreloadedFile.php-9"></a>            <span class="k">if</span> <span class="p">(</span><span class="nb">preg_match</span><span class="p">(</span><span class="nx">\Cloudinary\PreloadedFile</span><span class="o">::</span><span class="nv">$PRELOADED_CLOUDINARY_PATH</span><span class="p">,</span> <span class="nv">$file_info</span><span class="p">,</span> <span class="nv">$matches</span><span class="p">))</span> <span class="p">{</span>
<a name="PreloadedFile.php-10"></a>                <span class="nv">$this</span><span class="o">-&gt;</span><span class="na">resource_type</span> <span class="o">=</span> <span class="nv">$matches</span><span class="p">[</span><span class="mi">1</span><span class="p">];</span> 
<a name="PreloadedFile.php-11"></a>                <span class="nv">$this</span><span class="o">-&gt;</span><span class="na">type</span> <span class="o">=</span> <span class="nv">$matches</span><span class="p">[</span><span class="mi">2</span><span class="p">];</span>
<a name="PreloadedFile.php-12"></a>                <span class="nv">$this</span><span class="o">-&gt;</span><span class="na">version</span> <span class="o">=</span> <span class="nv">$matches</span><span class="p">[</span><span class="mi">3</span><span class="p">];</span>
<a name="PreloadedFile.php-13"></a>                <span class="nv">$this</span><span class="o">-&gt;</span><span class="na">filename</span> <span class="o">=</span> <span class="nv">$matches</span><span class="p">[</span><span class="mi">4</span><span class="p">];</span>
<a name="PreloadedFile.php-14"></a>                <span class="nv">$this</span><span class="o">-&gt;</span><span class="na">signature</span> <span class="o">=</span> <span class="nv">$matches</span><span class="p">[</span><span class="mi">5</span><span class="p">];</span>
<a name="PreloadedFile.php-15"></a>                <span class="nv">$public_id_and_format</span> <span class="o">=</span> <span class="nv">$this</span><span class="o">-&gt;</span><span class="na">split_format</span><span class="p">(</span><span class="nv">$this</span><span class="o">-&gt;</span><span class="na">filename</span><span class="p">);</span>
<a name="PreloadedFile.php-16"></a>                <span class="nv">$this</span><span class="o">-&gt;</span><span class="na">public_id</span> <span class="o">=</span> <span class="nv">$public_id_and_format</span><span class="p">[</span><span class="mi">0</span><span class="p">];</span>
<a name="PreloadedFile.php-17"></a>                <span class="nv">$this</span><span class="o">-&gt;</span><span class="na">format</span> <span class="o">=</span> <span class="nv">$public_id_and_format</span><span class="p">[</span><span class="mi">1</span><span class="p">];</span> 
<a name="PreloadedFile.php-18"></a>            <span class="p">}</span> <span class="k">else</span> <span class="p">{</span>
<a name="PreloadedFile.php-19"></a>                <span class="k">throw</span> <span class="k">new</span> <span class="nx">\InvalidArgumentException</span><span class="p">(</span><span class="s2">&quot;Invalid preloaded file info&quot;</span><span class="p">);</span> 
<a name="PreloadedFile.php-20"></a>            <span class="p">}</span>     
<a name="PreloadedFile.php-21"></a>        <span class="p">}</span>
<a name="PreloadedFile.php-22"></a>        
<a name="PreloadedFile.php-23"></a>        <span class="k">public</span> <span class="k">function</span> <span class="nf">is_valid</span><span class="p">()</span> <span class="p">{</span>
<a name="PreloadedFile.php-24"></a>            <span class="nv">$public_id</span> <span class="o">=</span> <span class="nv">$this</span><span class="o">-&gt;</span><span class="na">resource_type</span> <span class="o">==</span> <span class="s2">&quot;raw&quot;</span> <span class="o">?</span> <span class="nv">$this</span><span class="o">-&gt;</span><span class="na">filename</span> <span class="o">:</span> <span class="nv">$this</span><span class="o">-&gt;</span><span class="na">public_id</span><span class="p">;</span>
<a name="PreloadedFile.php-25"></a>            <span class="nv">$expected_signature</span> <span class="o">=</span> <span class="nx">\Cloudinary</span><span class="o">::</span><span class="na">api_sign_request</span><span class="p">(</span><span class="k">array</span><span class="p">(</span><span class="s2">&quot;public_id&quot;</span> <span class="o">=&gt;</span> <span class="nv">$public_id</span><span class="p">,</span> <span class="s2">&quot;version&quot;</span> <span class="o">=&gt;</span> <span class="nv">$this</span><span class="o">-&gt;</span><span class="na">version</span><span class="p">),</span> <span class="nx">\Cloudinary</span><span class="o">::</span><span class="na">config_get</span><span class="p">(</span><span class="s2">&quot;api_secret&quot;</span><span class="p">));</span> 
<a name="PreloadedFile.php-26"></a>            <span class="k">return</span> <span class="nv">$this</span><span class="o">-&gt;</span><span class="na">signature</span> <span class="o">==</span> <span class="nv">$expected_signature</span><span class="p">;</span>     
<a name="PreloadedFile.php-27"></a>        <span class="p">}</span>
<a name="PreloadedFile.php-28"></a>    
<a name="PreloadedFile.php-29"></a>        <span class="k">protected</span> <span class="k">function</span> <span class="nf">split_format</span><span class="p">(</span><span class="nv">$identifier</span><span class="p">)</span> <span class="p">{</span>
<a name="PreloadedFile.php-30"></a>            <span class="nv">$last_dot</span> <span class="o">=</span> <span class="nb">strrpos</span><span class="p">(</span><span class="nv">$identifier</span><span class="p">,</span> <span class="s2">&quot;.&quot;</span><span class="p">);</span>
<a name="PreloadedFile.php-31"></a>          
<a name="PreloadedFile.php-32"></a>            <span class="k">if</span> <span class="p">(</span><span class="nv">$last_dot</span> <span class="o">===</span> <span class="k">false</span><span class="p">)</span> <span class="p">{</span>
<a name="PreloadedFile.php-33"></a>                <span class="k">return</span> <span class="k">array</span><span class="p">(</span><span class="nv">$identifier</span><span class="p">,</span> <span class="k">NULL</span><span class="p">);</span>
<a name="PreloadedFile.php-34"></a>            <span class="p">}</span> 
<a name="PreloadedFile.php-35"></a>            <span class="nv">$public_id</span> <span class="o">=</span> <span class="nb">substr</span><span class="p">(</span><span class="nv">$identifier</span><span class="p">,</span> <span class="mi">0</span><span class="p">,</span> <span class="nv">$last_dot</span><span class="p">);</span> 
<a name="PreloadedFile.php-36"></a>            <span class="nv">$format</span> <span class="o">=</span> <span class="nb">substr</span><span class="p">(</span><span class="nv">$identifier</span><span class="p">,</span> <span class="nv">$last_dot</span><span class="o">+</span><span class="mi">1</span><span class="p">);</span>
<a name="PreloadedFile.php-37"></a>            <span class="k">return</span> <span class="k">array</span><span class="p">(</span><span class="nv">$public_id</span><span class="p">,</span> <span class="nv">$format</span><span class="p">);</span>    
<a name="PreloadedFile.php-38"></a>        <span class="p">}</span>
<a name="PreloadedFile.php-39"></a>    
<a name="PreloadedFile.php-40"></a>        <span class="k">public</span> <span class="k">function</span> <span class="nf">identifier</span><span class="p">()</span> <span class="p">{</span>
<a name="PreloadedFile.php-41"></a>            <span class="k">return</span> <span class="s2">&quot;v&quot;</span> <span class="o">.</span> <span class="nv">$this</span><span class="o">-&gt;</span><span class="na">version</span> <span class="o">.</span> <span class="s2">&quot;/&quot;</span> <span class="o">.</span> <span class="nv">$this</span><span class="o">-&gt;</span><span class="na">filename</span><span class="p">;</span>
<a name="PreloadedFile.php-42"></a>        <span class="p">}</span>
<a name="PreloadedFile.php-43"></a>        
<a name="PreloadedFile.php-44"></a>        <span class="k">public</span> <span class="k">function</span> <span class="nf">extended_identifier</span><span class="p">()</span> <span class="p">{</span>
<a name="PreloadedFile.php-45"></a>            <span class="k">return</span> <span class="nv">$this</span><span class="o">-&gt;</span><span class="na">resource_type</span> <span class="o">.</span> <span class="s2">&quot;/&quot;</span> <span class="o">.</span> <span class="nv">$this</span><span class="o">-&gt;</span><span class="na">type</span> <span class="o">.</span> <span class="s2">&quot;/&quot;</span> <span class="o">.</span> <span class="nv">$this</span><span class="o">-&gt;</span><span class="na">identifier</span><span class="p">();</span>
<a name="PreloadedFile.php-46"></a>        <span class="p">}</span>
<a name="PreloadedFile.php-47"></a>    
<a name="PreloadedFile.php-48"></a>        <span class="k">public</span> <span class="k">function</span> <span class="fm">__toString</span><span class="p">()</span> <span class="p">{</span>
<a name="PreloadedFile.php-49"></a>            <span class="k">return</span> <span class="nv">$this</span><span class="o">-&gt;</span><span class="na">resource_type</span> <span class="o">.</span> <span class="s2">&quot;/&quot;</span> <span class="o">.</span> <span class="nv">$this</span><span class="o">-&gt;</span><span class="na">type</span> <span class="o">.</span> <span class="s2">&quot;/v&quot;</span> <span class="o">.</span> <span class="nv">$this</span><span class="o">-&gt;</span><span class="na">version</span> <span class="o">.</span> <span class="s2">&quot;/&quot;</span> <span class="o">.</span> <span class="nv">$this</span><span class="o">-&gt;</span><span class="na">filename</span> <span class="o">.</span> <span class="s2">&quot;#&quot;</span> <span class="o">.</span> <span class="nv">$this</span><span class="o">-&gt;</span><span class="na">signature</span><span class="p">;</span>
<a name="PreloadedFile.php-50"></a>        <span class="p">}</span>    
<a name="PreloadedFile.php-51"></a>    <span class="p">}</span>
<a name="PreloadedFile.php-52"></a><span class="p">}</span>
</pre></div>
</td></tr></table>
    </div>
    ...
    <div class="tab-pane active-pane" id="branches" data-filter-placeholder="Filter branches">
      <ol class="filter-list">
        ...
        [[#branches]]
            ...
            [[#hasMultipleHeads]]
              [[#heads]]
                <li class="comprev filter-item">
                  <a class="pjax-trigger filter-item-link" href="/crazyhare86/aimee_debug/src/[[changeset]]/app/Http/Controllers/cloudinary/PreloadedFile.php?at=[[safeName]]"
                     title="[[name]]">
                    [[name]] ([[shortChangeset]])
                  </a>
                </li>
            ...
            [[^hasMultipleHeads]]
              <li class="comprev filter-item">
                <a class="pjax-trigger filter-item-link" href="/crazyhare86/aimee_debug/src/[[changeset]]/app/Http/Controllers/cloudinary/PreloadedFile.php?at=[[safeName]]" title="[[name]]">
                  [[name]]
                </a>
              </li>
            [[/hasMultipleHeads]]
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","queueTime":0,"licenseKey":"a2cef8c3d3","agent":"","transactionName":"Z11RZxdWW0cEVkYLDV4XdUYLVEFdClsdAAtEWkZQDlJBGgRFQhFMQl1DXFcZQ10AQkFYBFlUVlEXWEJHAA==","applicationID":"1841284","errorBeacon":"bam.nr-data.net","applicationTime":257}</script>
</body>
</html>