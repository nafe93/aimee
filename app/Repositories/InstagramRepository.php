...
class InstagramRepository
{
    ...
    //    if (is_array($config)) {
            ...
            $this->setApiKey(env('INSTAGRAM_CLIENT_ID'));//$config['apiKey']);
            $this->setApiSecret(env('INSTAGRAM_CLIENT_SECRET'));//$config['apiSecret']);
            $this->setApiCallback(env('INSTAGRAM_CALLBACK_URL'));//$config['apiCallback']);]
    ...
    {
        return $this->_makeCall('media/upload/', false, array('lat' => $lat, 'lng' => $lng, 'distance' => $distance));
    }
