            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <i class="fa fa-btn fa-spinner fa-spin"></i>{{ trans('kiosk/profile.loading') }}
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <!-- Email Address -->
                                    <p>
                                        <strong>{{ trans('kiosk/profile.email-address:') }}</strong> <a href="mailto:@{{ profile.email }}">@{{ profile.email }}</a>
                                    </p>

                                    <!-- Joined Date -->
                                    <p>
                                        <strong>{{ trans('kiosk/profile.joined:') }}</strong> @{{ profile.created_at | datetime }}
                                    </p>
                                    ...
                                    <p>
                                        ...
                                        <span v-else>
                                            {{ trans('kiosk/profile.none') }}
                                        </span>
                                    </p>

                                    <!-- Total Revenue -->
                                    <p>
                                        <strong>{{ trans('kiosk/profile.total-revenue:') }}</strong> @{{ revenue | currency spark.currencySymbol }}
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table class="table table-borderless m-b-none">
                                <thead>
                                    <th></th>
                                    <th>{{ trans('kiosk/profile.name') }}</th>
                                    <th>{{ trans('kiosk/profile.subscription') }}</th>
                                </thead>
