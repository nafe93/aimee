    ...
    <div>
        <div v-show=" ! showingUserProfile">
                        ...
                        <div class="form-group m-b-none">
                            <div class="col-md-12">
                                <input type="text" id="kiosk-users-search" class="form-control"
                                        name="search"
                                        placeholder="{{ trans('kiosk/users.search-by') }}"
            ...
            <div class="panel panel-default" v-if="searching">
                <div class="panel-heading">{{ trans('kiosk/users.search-results') }}</div>

                <div class="panel-body">
                    <i class="fa fa-btn fa-spinner fa-spin"></i>{{ trans('kiosk/users.searching') }}
                </div>
            </div>
            ...
            <div class="panel panel-warning" v-if=" ! searching && noSearchResults">
                ...
                <div class="panel-body">
                    {{ trans('kiosk/users.no-users-matched') }}
                </div>
            </div>
            ...
            <div class="panel panel-default" v-if=" ! searching && searchResults.length > 0">
                ...
                <div class="panel-body">
                    <table class="table table-borderless m-b-none">
                        <thead>
                            <th></th>
                            <th>{{ trans('kiosk/users.name') }}</th>
                            <th>{{ trans('kiosk/users.email-address') }}</th>
                            <th></th>
                        </thead>
