                ...
                <div class="modal-content">
                    <div class="modal-header text-center">
                        <div class="btn-group">
                            <button class="btn btn-default" :class="{'active': showingNotifications}" @click="showNotifications" style="width: 50%;">
                                {{ trans('modals/notifications.notifications') }}
                            </button>

                            <button class="btn btn-default" :class="{'active': showingAnnouncements}" @click="showAnnouncements" style="width: 50%;">
                                {{ trans('modals/notifications.announcements') }} <i class="fa fa-circle text-danger p-l-xs" v-if="hasUnreadAnnouncements"></i>
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div v-if="loadingNotifications">
                            <i class="fa fa-btn fa-spinner fa-spin"></i>{{ trans('modals/notifications.loading-notifications') }}
                        </div>

                        <div v-if=" ! loadingNotifications && activeNotifications.length == 0">
                            <div class="alert alert-warning m-b-none">
                                {{ trans('modals/notifications.none') }}
                            </div>
                        </div>

                        <!-- List Of Notifications -->
                        <div class="notification-container" v-if="showingNotifications">
                                ...
                                <div class="notification-content">
                                    <div class="meta">
                                        <p class="title">
                                            ...
                                            <span v-else>
                                                {{ trans('modals/notifications.sign2') }}
                                            </span>
                                        </p>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">{{ trans('modals/notifications.close') }}</button>
                    </div>
                </div>
            </div>
        </div>
