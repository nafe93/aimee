                            ...
                            <ul class="nav spark-settings-stacked-tabs" role="tablist">
                                ...
                                <li role="presentation">
                                    <a href="#account" aria-controls="account" role="tab" data-toggle="tab">
                                        <i class="fa fa-fw fa-btn fa-edit"></i>{{ trans('settings.account') }}
                                    </a>
                                </li>
                                ...
                                @if (Spark::usesTeams())
                                    <li role="presentation">
                                        <a href="#teams" aria-controls="teams" role="tab" data-toggle="tab">
                                            <i class="fa fa-fw fa-btn fa-users"></i>{{ trans('settings.teams') }}
                                        </a>
                                    </li>
                                @endif
                                ...
                                <li role="presentation">
                                    <a href="#security" aria-controls="security" role="tab" data-toggle="tab">
                                        <i class="fa fa-fw fa-btn fa-lock"></i>{{ trans('settings.security') }}
                                    </a>
                                </li>
                                ...
                                @if (Spark::usesApi())
                                    <li role="presentation">
                                        <a href="#api" aria-controls="api" role="tab" data-toggle="tab">
                                            <i class="fa fa-fw fa-btn fa-cubes"></i>{{ trans('settings.api') }}
                                        </a>
                                    </li>
                                @endif
                            </ul>
                                ...
                                <ul class="nav spark-settings-stacked-tabs" role="tablist">
                                    @if (Spark::hasPaidPlans())
                                        ...
                                        <li role="presentation">
                                            <a href="#subscription" aria-controls="subscription" role="tab" data-toggle="tab">
                                                <i class="fa fa-fw fa-btn fa-shopping-bag"></i>{{ trans('settings.subscription') }}
                                            </a>
                                        </li>
                                    @endif
                                    ...
                                    <li role="presentation">
                                        <a href="#payment-method" aria-controls="payment-method" role="tab" data-toggle="tab">
                                            <i class="fa fa-fw fa-btn fa-credit-card"></i>{{ trans('settings.payment-method') }}
                                        </a>
                                    </li>
                                    ...
                                    <li role="presentation">
                                        <a href="#invoices" aria-controls="invoices" role="tab" data-toggle="tab">
                                            <i class="fa fa-fw fa-btn fa-history"></i>{{ trans('settings.invoices') }}
                                        </a>
                                    </li>
                                </ul>
                            </div>
