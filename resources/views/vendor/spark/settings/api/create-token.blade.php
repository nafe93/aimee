    ...
    <div>
        <div class="panel panel-default">
            <div class="panel-heading">
                {{ trans('settings/api/create-token.create-api-token') }}
            </div>
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group" :class="{'has-error': form.errors.has('name')}">
                        <label class="col-md-4 control-label">{{ trans('settings/api/create-token.token-name') }}</label>
                    ...
                    <div class="form-group" v-if="availableAbilities.length > 0">
                        ...
                        <div class="col-md-6">
                            <button class="btn btn-default" @click.prevent="assignAllAbilities" v-if=" ! allAbilitiesAssigned">
                                <i class="fa fa-btn fa-check"></i>{{ trans('settings/api/create-token.assign-all-abilities') }}
                            </button>

                            <button class="btn btn-default" @click.prevent="removeAllAbilities" v-if="allAbilitiesAssigned">
                                <i class="fa fa-btn fa-times"></i>{{ trans('settings/api/create-token.remove-all-abilities') }}
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="form-group" :class="{'has-error': form.errors.has('abilities')}" v-if="availableAbilities.length > 0">
                        <label class="col-md-4 control-label">{{ trans('settings/api/create-token.token-can') }}</label>
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-4 col-md-6">
                            <button type="submit" class="btn btn-primary"
                                ...
                                {{ trans('settings/api/create-token.create') }}
                            </button>
                        </div>
                    </div>
                </form>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">
                            {{ trans('settings/api/create-token.api-token') }}
                        </h4>
                    </div>

                    <div class="modal-body">
                        <div class="alert alert-warning">
                            {{ trans('settings/api/create-token.new-api-token') }} <strong>{{ trans('settings/api/create-token.warn-dont-lose') }}</strong> {{ trans('settings/api/create-token.revoke-any-time') }}
                        </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">{{ trans('settings/api/create-token.close') }}</button>
                    </div>
                </div>
            </div>
        </div>
