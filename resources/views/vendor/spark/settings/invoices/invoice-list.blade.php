<spark-invoice-list :user="user" :team="team"
    ...
    <div class="panel panel-default">
        <div class="panel-heading">{{ trans('settings/invoices/invoice-list.invoices') }}</div>
                        ...
                        <td class="text-right">
                            <a :href="downloadUrlFor(invoice)">
                                <button class="btn btn-default">
                                    <i class="fa fa-btn fa-file-pdf-o"></i>{{ trans('settings/invoices/invoice-list.download-pdf') }}
                                </button>
                            </a>
                        </td>
                    </tr>
